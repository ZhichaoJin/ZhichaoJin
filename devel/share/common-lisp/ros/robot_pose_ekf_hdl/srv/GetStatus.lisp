...
(cl:defmethod cl:initialize-instance :after ((m <GetStatus-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetStatus-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_pose_ekf_hdl-srv:<GetStatus-request> is deprecated: use robot_pose_ekf_hdl-srv:GetStatus-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetStatus-request>)))
  ...
  "robot_pose_ekf_hdl/GetStatusRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetStatus-request)))
  "Returns string type for a service object of type 'GetStatus-request"
  "robot_pose_ekf_hdl/GetStatusRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetStatus-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetStatus-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_pose_ekf_hdl-srv:<GetStatus-response> is deprecated: use robot_pose_ekf_hdl-srv:GetStatus-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <GetStatus-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_pose_ekf_hdl-srv:status-val is deprecated.  Use robot_pose_ekf_hdl-srv:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetStatus-response>)))
  ...
  "robot_pose_ekf_hdl/GetStatusResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetStatus-response)))
  "Returns string type for a service object of type 'GetStatus-response"
  "robot_pose_ekf_hdl/GetStatusResponse")
