...
if(NOT "/home/jzc/robot_pose_ekf_ws/devel/include " STREQUAL " ")
  set(robot_pose_ekf_hdl_INCLUDE_DIRS "")
  set(_include_dirs "/home/jzc/robot_pose_ekf_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_pose_ekf_hdl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jzc/robot_pose_ekf_ws/src/robot_pose_ekf/${idir}'.  ${_report}")
    endif()
